...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  TD(ESC_TAP_DANCE),  MT(MOD_LCTL, KC_A), MT(MOD_LSFT, KC_S),  MT(MOD_LGUI, KC_D),  MT(MOD_LALT, KC_F),  KC_G,      KC_H,    MT(MOD_LALT, KC_J),    MT(MOD_RGUI, KC_K), MT(MOD_RSFT, KC_L),  MT(MOD_RCTL, KC_SCLN),   KC_QUOT,  KC_ENT,
  ...
  [_TRAINING_LAYER] = LAYOUT_60_ansi(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
      ...
      KC_NO,   KC_NO,   KC_NO, KC_TRNS, KC_TRNS,   KC_NO, KC_TRNS, TG(_TRAINING_LAYER)
  ),
};
